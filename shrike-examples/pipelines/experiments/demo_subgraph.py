...
from pipelines.subgraphs.probesubgraph import DemoSubgraph # import the subgraph
...
class DemoGraphWithSubgraph(AMLPipelineHelper):
    ...
    @classmethod
    def required_subgraphs(cls): # question: what is cls here?
    ...
    def build(self, config):
        ...
        probe_subgraph = self.subgraph_load("DemoSubgraph") # To-Do: load the subgraph
        ...
        def demo_pipeline_function(probe_dataset):
            ...
            probe_subgraph_step = probe_subgraph(
                ...
                param_verbose=config.probesubgraph.verbose,) # To-Do: to match the defination of the subgraph and the input yaml file
